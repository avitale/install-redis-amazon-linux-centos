...
echo "*****************************************"
sudo wget http://redis.googlecode.com/files/redis-2.6.9.tar.gz
sudo tar xzf redis-2.6.9.tar.gz
sudo rm redis-2.6.9.tar.gz -f
cd redis-2.6.9
sudo make
sudo make install
echo "*****************************************"
...
echo "*****************************************"
wget https://raw.github.com/avitale/install-redis-amazon-linux-centos/master/redis-server
echo "*****************************************"
